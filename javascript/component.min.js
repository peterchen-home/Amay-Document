...
b.downloadButton.downloadType&&(m=b.currentAttachmentName||"");if(location.protocol.match("file:"))return/^\/\//i.test(e)&&(e="https://"+e),window.open(e),q.return();if("downloadAll"==b.downloadButton.downloadType)return"English"==UserGroups&&(n=_get(htmlConfig,"meta.url","")||window.location.href,e=e.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(n))),bookConfig.isEncryptionBook&&(p=BookRestrict.getRestrictToken(),e=appendParamToUrl(e,"code="+p)),window.open(e,"_blank"),q.return();if(isAndroid()&&
